...
public class Product extends javax.swing.JPanel {
    ...
    public Product() {
        initComponents();
        this.setProductToTable();

    }
    public void setProductToTable( ){
        try{
            Connection con = DBConnection.getConnection();
            String sql="SELECT p.id as id, p.name as name, c.name as categoryName, sc.name as subCategoryName ,ps.unitBuyPrice as unitBuyPrice,ps.unitSellPrice as unitSellPrice,ps.totalBuyPrice as totalBuyPrice,ps.totalSellPrice as totalSellPrice, ps.totalStock as totalStock FROM products as p left join categories as c on (c.id=p.categoryId) left join subCategories as sc on (sc.id=p.subCategoryId) left join productStocks as ps on (ps.productId=p.id);";
            ...
            while(rs.next()){
                ...
                String subCategoryId = rs.getString("subCategoryName");
                ...
                Object obj[] = {id, name, categoryId, subCategoryId,totalStock,unitBuyPrice,unitSellPrice,totalBuyPrice,totalSellPrice};
    ...
    private void initComponents() {
        ...
        jLabel22.setText("Nhập xuất hàng");
        ...
        productTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Product name", "Category ", "Sub-category", "Quantity", "Unit Buy Price", "Unit Sell Price", "Total Buy Price", "Total Sell Price"
            }
        ) {
